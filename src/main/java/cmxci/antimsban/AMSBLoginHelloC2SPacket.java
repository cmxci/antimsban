...
public record AMSBLoginHelloC2SPacket(String name, Optional<PlayerPublicKey.PublicKeyData> publicKey, GameProfile clientAuthProfile, String clientAccessToken) implements Packet<ServerLoginPacketListener> {
    public AMSBLoginHelloC2SPacket(PacketByteBuf buf) {
        this(buf.readString(16), buf.readOptional(PlayerPublicKey.PublicKeyData::new), buf.readGameProfile(), buf.readString());
    }
